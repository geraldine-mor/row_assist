...
def get_user_age():
    ...
    while True:
        ...
        if validate_age(user_age):
            utils.typed(f"You entered: {user_age}")
            print("\n")
            break
...
def validate_age(data):
    ...
    try: 
        ...
        utils.typed("Invalid age, please enter a whole number between 10 and 100")
        print("\n")
        return False
    except TypeError:
...
def get_user_gender():
    ...
    while True:
        ...
        if validate_gender(user_gender):
            utils.typed(f"You entered: {user_gender}")
            print("\n")
            break
...
def get_user_row_time():
    ...
    """
    utils.typed("Please enter your latest 2k test time. Minutes, then seconds, then tenths\n")
    ...
    utils.typed(f"You entered: {user_row_time}")
    print("\n")               
...
def validate_time(data):
    ...
    try:
        ...
        utils.typed("Invalid entry, please enter a minutes value between 0 and 59")
        print("\n")
        return False
...
def validate_tenths(data):
    ...
    try:
        ...
        utils.typed("Invalid entry, please enter a tenths value between 0 and 9")
        print("\n")
        return False
